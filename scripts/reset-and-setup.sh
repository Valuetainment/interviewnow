...
echo ""
echo "Admin/General Users:"
echo "  - admin@testcompany.com (Admin)"
echo "  - user@testcompany.com (User)"
echo ""
echo "TechCorp Solutions Candidates:"
echo "  - john.smith@example.com (User)"
echo "  - sarah.johnson@example.com (User)"
echo "  - michael.chen@example.com (User)"
echo ""
echo "InnovateTech Labs Candidates:"
echo "  - emily.rodriguez@example.com (User)"
echo "  - david.park@example.com (User)"
echo "  - sophia.zhang@example.com (User)" 