...
CREATE POLICY "tenant_isolation_candidates" ON "public"."candidates" USING (("tenant_id" = ("current_setting"('request.jwt.claim.tenant_id'::"text"))::"uuid"));
...
CREATE POLICY "tenant_isolation_users" ON "public"."users" USING (("tenant_id" = ("current_setting"('request.jwt.claim.tenant_id'::"text"))::"uuid"));
