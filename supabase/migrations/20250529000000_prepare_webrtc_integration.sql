...
CREATE INDEX IF NOT EXISTS idx_video_segments_session_id
...
DROP TRIGGER IF EXISTS set_video_segment_tenant_id ON video_segments;
CREATE TRIGGER set_video_segment_tenant_id
